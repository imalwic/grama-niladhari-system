...
export default function GNGrievancesManagementPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await fetch("http://localhost:3001/grievances/gn", {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-amber-700 dark:text-amber-500">Local Grievances</h1>
          <p className="text-muted-foreground">Manage complaints reported by residents in your division</p>
        </div>
      </div>
